...
class Post(db.Model):
  ...
  def default_posts():
    if Post.query.count() == 0:
      post1=Post(title='Let\'s talk life?', body="An effective way to develop fundamental skills, which changed my predefined approach to learning and working. The course is well structured and a lot of thought has been put into the order and design of the videos. I would recommend it to anyone who is courageous enough to completely re-engineer their current way of thinking.")
